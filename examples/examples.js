...
const APCA_LABELS = [//[0, 15,  22,   30,     37.5,     45,     52.5,    60,      67.5,    75,     82.5,     90,  110 ];
		['REJECT','BORDER','BORDER','SPOT','SUBFLT','FLUENT','FLUENT','FLUENT','FLUENT','FLUENT','TOO-HI','TOO-HI'], // 32px
		['REJECT','REJECT','BORDER','DISTXT','SPOT','SUBFLT','FLUENT','BODYMN','BODYMN','BODYTX','BODYTX','TOO-HI'], // 24px
		['REJECT','REJECT','REJECT','NONTXT','DISTXT','SPOT','SUBFLT','FLUENT','FLUENT','BODYMN','BODYTX','BODYTX'], // 18.7px
		['REJECT','REJECT','REJECT','BORDER','DISTXT','DISTXT','SPOT','FLUENT','FLUENT','BODYMN','BODYTX','BODYTX'], // 16px
		['REJECT','REJECT','REJECT','REJECT','NONTXT','NONTXT','SPOT','SPOT','SPOT','SUBFLT','SUBFLT','SUBFLT'], // 12px
	];
